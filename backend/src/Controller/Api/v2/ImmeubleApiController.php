 ...
 */
#[Route("/api/v2/immeubles", name: "api_v2_immeuble_")]
class ImmeubleApiController extends AbstractApiController
{
    ...
    public function show(int $pkImmeuble, Request $request, Immeuble $immeubleService): JsonResponse
    {
        ...
        try {
            ...
            $v2 = $this->normalize($immeuble);
            $vOracle = $this->normalize($immeubleOracle);

            $v2['immeuble'] = $vOracle['Immeuble'];
            $v2['ImmeubleEC'] = $vOracle['ImmeubleEC'];
            $v2['ImmeubleEF'] = $vOracle['ImmeubleEF'];
            $v2['ImmeubleRepart'] = $vOracle['ImmeubleRepart'];
            $v2['ImmeubleCET'] = $vOracle['ImmeubleCET'];
            $v2['ImmeubleCapteur'] = $vOracle['ImmeubleCapteur']; 
