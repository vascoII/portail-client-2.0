...
class ExternalApiController extends AbstractApiController
{
    ...
    public function __construct(Client $client, SerializerInterface $serializer, SecurityService $securityService, ?FakeDataService $fakeDataService = null, ApiExternalService $apiExternalService)
    {
