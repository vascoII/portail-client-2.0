...
/**
 * Façade d'écriture Oracle dédiée aux opérations de suppression (DELETE).
 *
...
class OciDeleteHandler
{
    ...
    /**
     * Exécute un DELETE dans une transaction sécurisée.
     *
     * @param string $sql    Requête DELETE avec bind variables (:id, ...)
