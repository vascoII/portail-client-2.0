...
/**
 * Façade d'écriture Oracle dédiée aux opérations de mise à jour (UPDATE).
 *
...
class OciUpdateHandler
{
    ...
    /**
     * Exécute un UPDATE dans une transaction sécurisée.
     *
     * @param string $sql    Requête UPDATE avec bind variables (:id, :name, ...)
